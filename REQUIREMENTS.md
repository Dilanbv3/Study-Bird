...
| Peer leaderboards recording and ranking highest point earners in groups of students | Superfluous | This feature was thought of to aim at students competitive minded motivation in order to better push them to achieve more, although a feature that is not present in most other alternatives due to students survey answers a majority would rather not share their progress information with peers therefor this requirement would be superfluous |
