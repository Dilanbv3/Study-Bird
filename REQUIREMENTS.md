...
| Implementation of a point based reward system | Nice to Have | Being a quirky fun feature this can be deemed as quite advantageous to have in Study Bird to motivate students through a reward based system which based upon th student may get them to put more effort in to their studies. However, this cannot be deemed mandatory but rather Nice to Have with students also answering postively in regards to implementing it in Study bird based on the survey.| 
